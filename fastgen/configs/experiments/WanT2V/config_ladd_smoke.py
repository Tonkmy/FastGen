...
from fastgen.configs.experiments.WanT2V.config_ladd import create_config as ladd_wan_create_config
...
def create_config():
    ...
    config.log_config.name = "wan21_t2v_ladd_OpenVid_global_8"
...
#     --config=fastgen/configs/experiments/WanT2V/config_ladd_smoke.py
#
